...
@MessageDriven(activationConfig = {
        @ActivationConfigProperty(propertyName
                = "destinationLookup", propertyValue = "jms/QueueCliente"),
        @ActivationConfigProperty(propertyName
...
public class NotificarCliente implements MessageListener {
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            Logger.getLogger(NotificarCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
